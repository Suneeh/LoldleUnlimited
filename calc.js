...
// Gathered from https://ddragon.leagueoflegends.com/cdn/14.16.1/data/en_US/champion.json
var apiChamps = {
    "type": "champion",
...
// Combines information of both
console.log(Object.keys(apiChamps.data).map(apiChampId => {
    let apiChamp = apiChamps.data[apiChampId];
    let loldleChamp = loldleChamps.find(champ => champ.championName == apiChamp.name);
    console.log(loldleChamp);
    return ({
        id: apiChamp.id,
        title: apiChamp.title,
        gender: loldleChamp.gender,
        name: loldleChamp.championName,
        positions: loldleChamp.positions,
        regions: loldleChamp.regions,
        species: loldleChamp.species,
        releaseDate: loldleChamp.release_date,
        resource: loldleChamp.resource,
        rangeTypes: loldleChamp.range_type
    });
}));