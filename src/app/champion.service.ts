...
export class ChampionService {
  ...
  getPassiveIconUrl(): Observable<string> {
    const result = this.http
      .get(`https://ddragon.leagueoflegends.com/cdn/15.11.1/data/en_US/champion/${this.correctCampion.id}.json`, {
      ...
      .pipe(
        ...
        map((obj: any) => {
          ...
          return `https://ddragon.leagueoflegends.com/cdn/15.11.1/img/passive/${
